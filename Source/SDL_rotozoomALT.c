...
//File has being altered
zoomSurface now takes a dst surface
...
*/
SDL_Surface *zoomSurface(SDL_Surface * src, SDL_Surface * dst, double zoomx, double zoomy, int smooth)
{
	SDL_Surface *rz_src;
	SDL_Surface *rz_dst = dst;
